  ...
  return (
    <View className="flex-1 px-[24px] gap-y-[24px]">
      <View className="mt-[24px] gap-y-[16px] items-start">
        <Text className="text-[24px] font-PlusJakartaSansBold text-[#f4f4f4]">Mint your Tribe Pass</Text>
      ...
      <View className="px-[8px] pt-[8px] pb-[32px] h-[60%] border-[0.5px] border-[#787A80] bg-[#0A0B0F] gap-y-[16px] rounded-[32px]">
        ...
        <View className="flex-row items-end px-[16px]">
          <View className="flex-1 gap-y-[8px]">
            <Text className="text-[24px] text-[#FAFBFB] font-PlusJakartaSansBold">{name as string}</Text>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text className="text-[20px] font-PlusJakartaSansBold text-white mb-4">Mint collectible</Text>
            <Text className="text-[16px] font-PlusJakartaSansBold text-[#787A80]">pay</Text>
            <Text className="text-[28px] font-PlusJakartaSansBold text-white mb-6">$2.00</Text>
            </View>
            ...
            <AppButton.Primary
              ...
              text="Pay with USDC"
              loading={false}
              icon={<Image source={require("../../assets/images/usdc-icon.png")} className="w-5 h-5" />}
              onPress={() =>{
