...
const MusicDetails = () => {
    ...
    const text = "Vultures 2 is the second studio album by the sensational hiphop duo ¥$...";
    const truncatedText = text.length > 100 ? `${text.substring(0, 130)}...` : text;
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                ...
                {/* Title */}
                <View style={styles.contentWrapper}>
                    <Text style={[styles.title, { fontSize: width * 0.06 }]} numberOfLines={1}>
                        {title}
                    </Text>
