                    ...
                    <View className="bg-[#2A1708] p-[12px] flex-row items-start gap-[12px] max-w-full rounded-[12px] overflow-hidden">
                        ...
                        <View className="flex-1">
                            <Text className="text-[14px] text-[#EC6519] font-PlusJakartaSansRegular flex-shrink">
                                Your password is encrypted and used to create a local backup of your private key to your device so you don’t lose access to your account. Think private keys as a pin to access your account/wallet
                            </Text>
                        </View>
                    </View>
