...
const signin = () => {
    ...
    const {handleAppleSignUp, handleEmailSignUp, handleGoogleSignUp, handleEmailSignIn, loading} = useClerkAuthentication()
  return (
    <SafeAreaView style={{
        flex: 1,
      ...
      <View className="gap-y-12 mt-6">
        ...
        <TouchableOpacity onPress={() => handleEmailSignIn(emailAddress, password)}  className="bg-orange-500 items-center py-4 rounded-full">
      ...
      {/* <View className="flex-row items-center justify-center gap-x-[2px] absolute bottom-12 left-0 right-0">
        <Text className="text-[#787A80] font-PlusJakartaSansMedium text-[16px]">Powered by</Text>
        <Image source={require("../../assets/images/starknet.png")} />
        <Text className="text-[#787A80] font-PlusJakartaSansMedium text-[16px]">Starknet</Text>
      </View> */}
    </SafeAreaView>
  )
}
