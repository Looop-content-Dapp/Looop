...
const PaymentNotification = () => {
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            headerLeft: () => <AppBackButton name='Payment Updates' onBackPress={() => router.back()} />,
            headerRight: () => null
        })
    }, [])
    ...
    return (
        <View className='flex-1 px-[24px] pt-[20px]'>
            <Text className='text-[14px] text-[#63656B] font-PlusJakartaSansMedium mb-[32px]'>
                Get notified about changes to your payment methods and billing information.
            </Text>
            ...
            <View className='gap-y-[24px]'>
                <View className='flex-row items-center justify-between py-[16px]'>
                    <View>
                        ...
                        <Text className='text-[14px] font-PlusJakartaSansMedium text-[#787A80]'>
                            Instant alerts for payment changes
                        </Text>
                    </View>
                    <Switch
                        value={pushEnabled}
                ...
                <View className='flex-row items-center justify-between py-[16px]'>
                    <View>
                        ...
                        <Text className='text-[14px] font-PlusJakartaSansMedium text-[#787A80]'>
                            Detailed payment update emails
                        </Text>
                    </View>
                    <Switch
                        value={emailEnabled}
