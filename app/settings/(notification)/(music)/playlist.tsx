...
const PlaylistNotification = () => {
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            headerLeft: () => <AppBackButton name='Playlist Updates' onBackPress={() => router.back()} />,
            headerRight: () => null
        })
    }, [])
    ...
    return (
        <View className='flex-1 px-[24px] pt-[20px]'>
            <Text className='text-[14px] text-[#63656B] font-PlusJakartaSansMedium mb-[32px]'>
                Get notified when there are updates to playlists you follow or when your playlists get new followers.
            </Text>
            ...
            <View className='gap-y-[24px]'>
                <View className='flex-row items-center justify-between py-[16px]'>
                    <View>
                        ...
                        <Text className='text-[14px] font-PlusJakartaSansMedium text-[#787A80]'>
                            Receive instant alerts for playlist changes
                        </Text>
                    </View>
                    <Switch
                        value={pushEnabled}
                ...
                <View className='flex-row items-center justify-between py-[16px]'>
                    <View>
                        ...
                        <Text className='text-[14px] font-PlusJakartaSansMedium text-[#787A80]'>
                            Get email digests about playlist activity
                        </Text>
                    </View>
                    <Switch
                        value={emailEnabled}
