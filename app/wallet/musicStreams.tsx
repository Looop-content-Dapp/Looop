...
const musicStreams = () => {
    ...
    const payoutHistory = [
      { amount: 1284, date: "January 2025", time: "04:00 PM", txId: "#47388" },
      { amount: 1498, date: "January 2025", time: "08:50 PM", txId: "#32374" },
      { amount: 824, date: "January 2025", time: "06:00 PM", txId: "#28392" },
      { amount: 949, date: "December 2024", time: "04:00 PM", txId: "#47374" },
    ];
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            headerLeft: () => <AppBackButton name='Music Streams' onBackPress={() => router.back()} />,
        })
      }, [])
