...
const uploadSingle = () => {
  ...
  return (
    ...
    >
      <Text className='text-[24px] font-PlusJakartaSansBold leading-[30px] text-[#F4F4F4]'>Upload single - {flow}</Text>
      <View className='py-[32px] px-[24px] bg-[#0A0B0F] gap-y-[32px] mt-[32px]'>
        <Text className='text-[#787A80] text-[20px] leading-[22px] font-PlusJakartaSansMedium text-start'>Track info</Text>
       {handleFlow()}
      </View>
      <AppButton.Primary
      text='Continue'
