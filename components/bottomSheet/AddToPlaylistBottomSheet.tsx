...
const AddToPlaylistBottomSheet = ({
        ...
        },
        {
          onSuccess: (data) => {
            ...
            showNotification({
              ...
              } added to ${playlistCount} ${
                playlistCount > 1 ? "playlists" : "playlist"
              } successfully`,
              position: "top",
            });
          },
        ...
        renderItem={({ item }) => (
          ...
          >
            <View className="flex-row items-center gap-x-3">
              ...
              />
              <View className="ml-3">
                <Text className="text-[#f4f4f4] text-[16px] font-PlusJakartaSansBold">
                  {item.title}
                </Text>
  ...
  return (
    ...
    >
      <BottomSheetView
        style={{ backgroundColor: "#111318", padding: 16, flex: 1 }}
      >
        <View className="flex-row gap-x-[40px] items-center mb-4 border-b-2 border-[#1D2029] pb-[20px]">
          ...
          <Text className="text-[16px] font-PlusJakartaSansMedium text-[#f4f4f4] font-bold">
            Add to Playlist
          </Text>
        </View>
        ...
        >
          ...
          <Text className="ml-3 text-[16px] font-PlusJakartaSansMedium text-white">
            Create a new playlist
          </Text>
        </TouchableOpacity>

        {/* Playlist section */}
        <Text className="text-[#f4f4f4] text-[20px] font-PlusJakartaSansMedium mb-2">
          My Library
        </Text>
