...
const albumCoverImage = require("../../../assets/images/rema.jpg");
  ...
  return (
    <View style={styles.container}>
      <ScrollView
        ...
        <Text style={styles.artistName}>By {album.artist}</Text>
        <Text style={styles.songCount}>
          Album • {album.numberOfSongs} songs
        </Text>
